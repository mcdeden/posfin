...
@section('subtitle', 'Pendaftaran Pengguna')
...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-validate-jquery" action="{{ route('securities.users.store') }}" method="POST">
            {{-- {{ csrf_field() }} --}} @csrf
            <fieldset class="mb-3">
                ...
                {{-- <div class="form-group row"> --}}
                    ...
                    <div class="col-lg-6">
                        <input type="email" id="email" name="email" class="form-control" id="email" required placeholder="email">
                    </div> --}}
                {{-- </div> --}}
                <!-- /email field -->
                ...
                <!-- Select2 select -->
                <div class="form-group row">
                    <!-- <label class="col-form-label col-lg-3" style="text-align: right">Nama Bank <span class="text-danger">*</span></label> -->
                    <label class="col-form-label col-lg-3" style="text-align: right">Nama Bank</label>
                    <div class="col-lg-3">
                        <select id="bank_id_user" name="bank_id_user" data-placeholder="Pilih Bank..." class="form-control form-control-select2 select-search"
                            required data-fouc>
                            <option></option>
                    ...
                    <div class="col-lg-3">
                            <select id="branch_id_user" name="branch_id_user" data-placeholder="Pilih Cabang..." class="form-control form-control-select2 select-search"
                                required data-fouc>
                                <option></option>
                            </select>
                        </div>
                ...
                <!-- /select2 select -->
                    ...
                    <div class="col-lg-3">
                        <select id="insurance_id_user" name="insurance_id_user" data-placeholder="Pilih Asuransi..." class="form-control form-control-select2 select-search"
                            required data-fouc>
                            <option></option>
            ...
            <fieldset class="mb-3">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="password" name="password" id="password" class="form-control" required placeholder="Password minimum 5 karakter">
                    </div>
                </div>
                <!-- /password field -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="password" name="repeat_password" class="form-control" required placeholder="Input ulang password">
                    </div>
                </div>
                <!-- /repeat password -->
...
<script>
    $(document).ready(function() {
        var bankID=$('#bank_id_user').val();
        if(bankID) {
            getBranches(bankID);
        }

        $('#branch_id_user').on('change', function() {
            // alert('test');
