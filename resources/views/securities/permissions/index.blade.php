...
<div class="card">
    <div class="card-header bg-light header-elements-inline">
        <h5 class="card-title">List Data Permission</h5>
        <div class="header-elements">
            <a href="{{ route('securities.permissions.create') }}" class="btn btn-primary btn-labeled btn-labeled-left"><b><i class="icon-plus3"></i></b> Tambah Permission</a>
        </div>
    </div>
        ...
        <table class="table datatable-button-html5-columns table-hover dtdata">
            <thead>
                <tr>
                    ...
                    <th style="width: 20%;">Nama Pendek</th>
...
<script>
    $(function() {
        ...
        var oTable = $('.dtdata').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! route('ajax.securities.permissions') !!}',
            },
            headers: {
