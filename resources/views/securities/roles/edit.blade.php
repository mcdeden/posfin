...
@section('subtitle', 'Edit Data Role')
...
<div class="card">
    <div class="card-header bg-light header-elements-inline">
        <h5 class="card-title">Form Edit Data Role</h5>
    ...
    <div class="card-body">
        <form class="form-validate-jquery" action="{{ route('securities.roles.update',$data) }}" method="POST">
                ...
                <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" value="{{ $item->id }}" @if($data->permissions->contains($item)) checked @endif>
                                                    {{ $item->name }}
                                            </label>
                                        </div>
                                        @endforeach
                    ...
                    <div class="form-group row">
                            ...
                            <div style="padding-left:10px;">
                                ...
                                <a href="{{ route('securities.roles.index') }}" class="btn btn-light ml-3" id="reset"><i class="icon-reload-alt mr-2"></i> Batal</a>
                            </div>
                        </div>
        </form>
    </div>
...
{{-- <script type="text/javascript" src="{{ asset('js/demo/form_checkboxes_radios.js') }}"></script> --}}
